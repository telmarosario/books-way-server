...
| --- | --- | --- | --- |
| /login | LoginPage | anonymous user only
<isAnon> | Login form navigates to the home page after login. |
| /signup | SignupPage | anonymous user only
<isAnon> | Signup form navigates to the login page after signup. |
| / | HomePage | public  | Homepage |
| /user-profile | ProfilePage | authenticated user only
<IsPrivate> | User profile for the current user |
| /user-profile/edit | EditProfilePage | authenticated user only
<IsPrivate> | Edit user profile form. |
| /user/:userId | OtherUser | authenticated user only
<IsPrivate> | Other users' profiles.  |
| /books/:bookId | BookDetails | authenticated user only
<IsPrivate> | Book details for specific user |
| /books/add-book | AddBook | authenticated user only
<IsPrivate> | Form to create a new book |
| /books/edit-book | EditBook | authenticated user only
<IsPrivate> | Form to edit a new book |
...
| GET | /api/user/:userId |  | 200 | 400 | Update user's profile |
